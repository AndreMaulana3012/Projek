  ...
  <body id="top">
    <header class="bg-light">
      <nav class="navbar navbar-expand-lg navbar-light bg-light" id="header-nav" role="navigation">
        <div class="container"><a class="link-dark navbar-brand site-title mb-0" href="#">Andre</a>
  ...
  <div class="cover bg-light">
    <div class="container px-3">
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="mt-5">
            <p class="lead text-uppercase mb-1">Hallo!</p>
            <h1 class="intro-title marker" data-aos="fade-left" data-aos-delay="50">Saya Andre Maulana</h1>
            <p class="lead fw-normal mt-3" data-aos="fade-up" data-aos-delay="100">Networking and Web Developer</p>
...
<div class="section pt-4 px-3 px-lg-4" id="about">
  <div class="container-narrow">
    <div class="row">
      <div class="col-md-6">
        <h2 class="h4 my-2">Hello! Saya Andre Maulana.</h2>
        <p>I am a beginner in Networking and Web Developer. I'm a passionate person when it comes to networking and Web Developer because it can add to my insight into it. I am a fast learner and team worker who gets the job done on time. I can maximize the time so that the results obtained are quite satisfactory.</p>
        <div class="row mt-3">
          <div class="col-sm-2">
            <div class="pb-1">Age:</div>
          </div>
          <div class="col-sm-10">
            <div class="pb-1 fw-bolder">18 tahun</div>
          </div>
          <div class="col-sm-2">
            <div class="pb-1">Email:</div>
          </div>
          <div class="col-sm-10">
            <div class="pb-1 fw-bolder">andreymaulana774@gmail.com</div>
          </div>
          </div>
          <div class="col-sm-2">
            <div class="pb-1">From:</div>
          </div>
          <div class="col-sm-10">
            <div class="pb-1 fw-bolder">Jakarta</div>
          </div>
          <div class="col-sm-2">
...
<div class="section px-3 px-lg-4 pt-5" id="services">
  <div class="container-narrow">
    ...
    <div class="row py-3" style="margin-left:220px">
